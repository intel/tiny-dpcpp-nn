...
//     } SUBCASE("Supported 12") { CHECK_NOTHROW(SwiftNetMLP<T, 16>(q, 16, 16, 4, Activation::Sigmoid,
//     Activation::ReLU)); } SUBCASE("Supported 13") {
...
//                                 + " - output_activation: " + output_activation + " - Batch size: " +
//                                 std::to_string(batch_size) + " - weight init: " + weight_init + " - random input:" +
//                                 random_string;
...
//     "linear",
//     //                                             "random");
//     // for (int batch_size = 10; batch_size < 20; batch_size++) {
//     //     test_grads<sycl::ext::oneapi::bfloat16, 16>(q, 16, output_dim, n_hidden_layers, 1 << batch_size, "relu",
//     //     "none",
//     //                                                 "random");
//     // }
...
TEST_CASE("Swiftnet - test grad input padded") {
    ...
    // for (int batch_size = 10; batch_size < 20; batch_size++) {
    //     test_grads<sycl::ext::oneapi::bfloat16, 16>(q,  input_dim, 16, n_hidden_layers, 1 << batch_size, "relu",
    //     "none",
    //                                                 "random");
    // }
